package net.anotheria.mailhunter.configurators;

import net.anotheria.mailhunter.EngineConfigurator;
import net.anotheria.mailhunter.TransformationEngine;
import net.anotheria.mailhunter.Transformation;
import net.anotheria.mailhunter.Transformer;
import net.anotheria.mailhunter.matcher.GenericAndMatcher;
import net.anotheria.mailhunter.matcher.GenericContainsMatcher;
import net.anotheria.mailhunter.transformer.CapitalsOnlyTransformer;
import net.anotheria.mailhunter.transformer.LettersOnlyTransformer;
import net.anotheria.mailhunter.transformer.NoOpTransformer;
import net.anotheria.mailhunter.transformer.RemoveDuplicateLettersTransformer;
import net.anotheria.mailhunter.transformer.RemoveWhitespacesTransformer;
import net.anotheria.mailhunter.transformer.ReverseStringTransformer;
import net.anotheria.mailhunter.transformer.StartingLettersTransformer;
import net.anotheria.mailhunter.transformer.ToLowerCaseTransformer;
import net.anotheria.mailhunter.transformer.ToMailAttributesTransformer;
