...
public class JDBCAccountListPersistenceServiceImpl extends BasePersistenceServiceJDBCImpl implements AccountListPersistenceService {
	...
	@Override
	public boolean addToList(AccountId owner, String listName, Collection<AccountIdAdditionalInfo> targets)
	...
	@Override
	public boolean removeFromList(AccountId owner, String listName, Collection<AccountIdAdditionalInfo> targets)
			throws AccountListPersistenceServiceException {
		if (targets != null && targets.size() == 0) {
			return true;
		}
