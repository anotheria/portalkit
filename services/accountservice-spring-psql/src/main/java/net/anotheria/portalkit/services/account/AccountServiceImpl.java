...
/**
 * The implementation of the account service, backed by Spring Data JPA / PostgreSQL.
 *
 * @author lrosenberg
...
public class AccountServiceImpl implements AccountService, AccountAdminService, EntityManagingService {
	...
	private Account getAccountInternally(AccountId accountId) throws AccountServiceException {
		...
		try{
			...
			throw new AccountServiceException("Persistence read failed for " + accountId, e);
		}
		if (entity == null) {
	...
	public void deleteAccount(AccountId id) throws AccountServiceException {
		...
		try {
			...
			throw new AccountServiceException("Persistence delete failed: "+e.getMessage(), e);
		}
	...
	private void saveAccount(Account toSave) throws AccountServiceException {
		...
		try {
			...
			throw new AccountServiceException("Persistence save failed", e);
		}
		...
		try {
			...
			throw new AccountServiceException("Persistence read after save failed", e);
		}
	}
	...
	private AccountId getAccountIdByNameInternally(String accountName) throws AccountServiceException {
		...
		try {
			...
			throw new AccountServiceException("Persistence read failed for name: " + accountName, e);
		}
	}
	...
	private AccountId getAccountIdByEmailInternally(String email) throws AccountServiceException {
		...
		try {
			...
			throw new AccountServiceException("Persistence read failed for email: " + email, e);
		}
	}
	...
	private AccountId getAccountIdByNameInternally(String accountName, String brand) throws AccountServiceException {
		...
		try {
			...
			throw new AccountServiceException("Persistence read failed for name and brand: " + accountName + ", " + brand, e);
		}
	}
	...
	public AccountNote getAccountNoteById(long id) throws AccountServiceException {
		try {
			...
			throw new AccountServiceException("Persistence failed to get account note by id: " + id, e);
		}
	}
	...
	public AccountNote updateAccountNote(AccountNote accountNote) throws AccountServiceException {
		try {
			...
			throw new AccountServiceException("Persistence failed to update account note with id " + accountNote.getId(), e);
		}
	}
	...
	public void deleteAccountNote(long id) throws AccountServiceException {
		try {
			...
			throw new AccountServiceException("Persistence failed to delete account note by id: " + id, e);
		}
	}
	...
	public List<AccountNote> getNotesByAccountId(AccountId accountId) throws AccountServiceException {
		try {
			...
			throw new AccountServiceException("Persistence failed to get account notes by account id: " + accountId, e);
		}
	}
	...
	private AccountId getAccountIdByEmailInternally(String accountEmail, String brand) throws AccountServiceException{
		...
		try {
			...
			throw new AccountServiceException("Persistence read failed for email and brand: " + accountEmail + ", " + brand, e);
		}
	}
