...
public class AccountSettingsServiceFactory implements ServiceFactory<AccountSettingsService> {
	...
	public AccountSettingsService create() {
		return ServiceProxyUtil.createServiceProxy(AccountSettingsService.class, new AccountSettingsServiceImpl(), "service", "portal-kit", true, UserDataManagingServiceWithIntegrityCheck.class);
	}
