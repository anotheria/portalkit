...
/**
 * Some preselected auth token types. Feel free to create your own.
 * The idea of this class is to have some kind of convinience between multiple portalkit projects.
 *
 * @author lrosenberg
