...
import net.anotheria.portalkit.services.common.query.BetweenModifier;
import net.anotheria.portalkit.services.common.query.BetweenQuery;
...
import net.anotheria.portalkit.services.common.query.LessThenModifier;
import net.anotheria.portalkit.services.common.query.LessThenQuery;
import net.anotheria.portalkit.services.common.query.LimitQuery;
import net.anotheria.portalkit.services.common.query.MoreThenModifier;
import net.anotheria.portalkit.services.common.query.MoreThenQuery;
...
import net.anotheria.portalkit.services.common.query.SortingType;
