...
public class OnlineStorage {
	...
	/**
	 * {@link OnlineActivityServiceEventSupplier} instance.
	 */
	private OnlineActivityServiceEventSupplier announcer;
	...
	public OnlineStorage() {
		...
		announcer = new OnlineActivityServiceEventSupplier();
	}
	...
	private void notifyLogOut(final AccountId account, boolean sendEvent) throws AccountIsOfflineException {
		...
		try {
			...
			//event announce
			if (sendEvent)
				announcer.accountLoggedOut(account, System.nanoTime());
