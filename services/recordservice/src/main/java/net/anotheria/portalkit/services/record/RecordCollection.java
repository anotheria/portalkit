...
/**
 * This class contains the complete collection for one owner, meaning all
 * elements in one collection of one user. This is making it easier to load and
 * cache collection-wise.
 * 
 * @author lrosenberg
...
public class RecordCollection {
	...
	/**
	 * The collection id of this record collection.
	 */
	private String collectionId;

	public RecordCollection(String aCollectionId) {
	...
	public RecordSet getRecordSet() {
		return getRecordSet(records.keySet());
	}

	public RecordSet getRecordSet(Collection<String> recordIds) {
		// TODO this method is actually not thread safe in a sense, that we can
		// have a modification in between of our operation.
